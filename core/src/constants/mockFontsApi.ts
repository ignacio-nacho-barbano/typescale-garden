...
/**
 * The bundled fallback catalogue, used when the Google Fonts snapshot has not
 * loaded. Deliberately tiny — it holds one family.
 */
export const mockFontsApi: { kind: string; items: ApiFont[] } = {
